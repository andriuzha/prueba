!function() {
  ...
  // Definición del objeto `f` para cargar archivos JSON mediante XMLHttpRequest
  var f = {
    load: function w(t, e) {
      var n = function r() {
  ...
  // Validador de opciones requeridas
  (function y(t) {
    if (!function e(t) {
  ...
  // Función para comparar cadenas de texto (usada para búsqueda)
  ...
  // Objeto para realizar búsquedas sensibles a mayúsculas/minúsculas
  ...
  // Objeto para realizar búsquedas exactas
  ...
  // Gestor de datos para almacenar y buscar elementos
  var l = {
    put: function z(t) {
      if (c(t)) return s(t);
      if (function e(t) {
  ...
  !function(t) {
    ...
    var n = ["searchInput", "resultsContainer", "json"];
